...
export const HuntMetadataEditor: React.FC<HuntMetadataEditorProps> = ({
  metadata,
  onMetadataChange,
}) => {
    ...
    <Card className="bg-white shadow-lg">
      ...
      <CardContent className="space-y-4">
        ...
        <div>
          ...
          <Label htmlFor="hunt-story-context">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <Input
              ...
              type="number"
              value={
                metadata.estimated_time_minutes === null ||
                metadata.estimated_time_minutes === undefined
                  ? ''
        ...
        <div className="flex items-center space-x-2">
          ...
          />
          <Label htmlFor="hunt-is-public" className="mb-0">
            Make this hunt publicly available
          </Label>
        </div>
      </CardContent>
    </Card>
