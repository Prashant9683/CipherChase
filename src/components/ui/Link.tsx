...
export const Link: React.FC<LinkProps> = ({
  ...
  const baseClasses =
    'transition-colors duration-150 ease-in-out focus:outline-none focus:ring-2 focus:ring-offset-1';

  const variantClasses = {
    default:
      'text-blue-600 hover:text-blue-700 hover:underline focus:ring-blue-500 font-medium',
    subtle:
      'text-gray-600 hover:text-gray-800 hover:underline focus:ring-gray-500 text-sm',
    buttonLike:
      'inline-block px-4 py-2 text-sm font-medium rounded-md text-center ' + // Use Button's primary styling as an example
