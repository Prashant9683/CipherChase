...
export const fetchUserAchievements = async (userId: string): Promise<Array<UserAchievement & { achievement: Achievement }>> => {
...
export const triggerAchievementCheck = async (
    ...
    const { data, error } = await supabase.functions.invoke('checkAndAwardAchievements', {
