                ...
                <div className="space-y-4">
                  ...
                  <div className="text-center">
                    <h3 className="text-lg font-medium">
                      {profile.display_name || 'Anonymous Explorer'}
                    </h3>
                  ...
                  {profile.favorite_cipher_type && (
                    <div className="bg-[#F5DEB3]/20 p-4 rounded-md border border-[#D4AF37]/30 col-span-2">
                      <div className="text-sm text-gray-500">
                        Favorite Cipher Type
                      </div>
                      <div className="text-xl font-bold text-[#1A3A5A]">
                        {profile.favorite_cipher_type.charAt(0).toUpperCase() +
                          profile.favorite_cipher_type.slice(1)}
                      </div>
                    </div>
                  )}
                </div>
                ...
                {profile.achievements && profile.achievements.length > 0 ? (
                  ...
                  <div className="text-center py-6 text-gray-500">
                    ...
                    <p className="text-sm mt-1">
                      Start solving puzzles and completing hunts to earn your
                      first achievement!
                    </p>
                  </div>
                )}
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-center py-6 text-gray-500">
                  ...
                  <p className="text-sm mt-1">
                    Your recent puzzles and hunts will appear here.
                  </p>
                </div>
              </CardContent>
            </Card>
