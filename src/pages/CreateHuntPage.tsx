...
const CreateHuntPage: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-white text-gray-800 py-10 font-sans">            <div className="container mx-auto px-4 md:px-6 lg:px-8">
                <header className="mb-10 text-center">
                    <Feather className="mx-auto h-16 w-16 text-blue-600 mb-4 animate-bounce" /> {/* Simple animation */}
                    <h1 className="text-4xl md:text-5xl font-bold text-gray-800 font-serif tracking-tight"> {/* Thematic font */}
                        Craft Your Legend
                    </h1>
                    <p className="text-lg text-gray-600 mt-3 max-w-2xl mx-auto">
                        Design intricate puzzles, weave compelling narratives, and share your unique treasure hunt with the world.
                    </p>
                </header>
